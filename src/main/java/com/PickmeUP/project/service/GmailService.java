...
public class GmailService {
    ...
    public static void sendCreatedMail(User user) {
        ...
        String createdHTML = "<html xmlns=\"http://www.w3.org/1999/xhtml\">\n" +
                ...
                "    <meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" />\n" +
                "    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\" />\n" +
                "    <title>Neue Fahrt erstellt:</title>\n" +
                "\n" +
                "    <style type=\"text/css\">\n" +
                "        /* Take care of image borders and formatting, client hacks */\n" +
                "        img { max-width: 600px; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic;}\n" +
    ...
    public static void sendBookingMailPassenger(User user) {
        String to = user.getEmail();
        String from = "pickmeup.uni.passau@gmail.com";
        final String username = "pickmeup.uni.passau@gmail.com";
        final String password = "lukpkucfltvvpxkf";
    ...
    public static void sendBookingMailDriver(User user) {
        String to = user.getEmail();
        String from = "pickmeup.uni.passau@gmail.com";
        final String username = "pickmeup.uni.passau@gmail.com";
        final String password = "lukpkucfltvvpxkf";
        ...
        String bookingHTML = "<html xmlns=\"http://www.w3.org/1999/xhtml\">\n" +
                ...
                "                    <tr>\n" +
                "                        <td class=\"free-text\">\n" +
                "                            Ein weiterer Nutzer hat eine deiner Fahrten gebucht ! Finde jetzt weitere Fahrten:\n" +
                "                        </td>\n" +
                "                    </tr>\n" +
                "                    <tr>\n" +
                "                        <td class=\"button\">\n" +
    ...
    public static void sendChangedJourneyMailPassenger(User user) {
        String to = user.getEmail();
        String from = "pickmeup.uni.passau@gmail.com";
        final String username = "pickmeup.uni.passau@gmail.com";
        final String password = "lukpkucfltvvpxkf";
        ...
        String changedJourneyHTML = "<html xmlns=\"http://www.w3.org/1999/xhtml\">\n" +
                "<head>\n" +
                "    <meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" />\n" +
                "    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\" />\n" +
                "    <title>Neuigkeiten bei deinen Mitfahrgelegenheiten!</title>\n" +
                "\n" +
                "    <style type=\"text/css\">\n" +
                "        /* Take care of image borders and formatting, client hacks */\n" +
                "        img { max-width: 600px; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic;}\n" +
                ...
                "                    <tr>\n" +
                "                        <td class=\"header-lg\">\n" +
                "                            Neuigkeiten bei deinen Mitfahrgelegenheiten!\n" +
                "                        </td>\n" +
                "                    </tr>\n" +
                "                    <tr>\n" +
                "                        <td class=\"free-text\">\n" +
                "                            Eine deiner Fahrten wurde geaendert oder gelöscht. Sieh in deinem Dashboard nach:\n" +
                "                        </td>\n" +
                "                    </tr>\n" +
                "                    <tr>\n" +
                "                        <td class=\"button\">\n" +
        ...
        try {
            ...
            // Set Subject: header field
            message.setSubject("Neuigkeiten bei PickmeUP");

            Multipart mp = new MimeMultipart();

            BodyPart pixPart = new MimeBodyPart();
            pixPart.setContent(changedJourneyHTML, "text/html");
    ...
    public static void sendJourneyInfoMail(User user) {
        String to = user.getEmail();
        String from = "pickmeup.uni.passau@gmail.com";
        final String username = "pickmeup.uni.passau@gmail.com";
        final String password = "lukpkucfltvvpxkf";
        ...
        String journeyInfoHTML = "<html xmlns=\"http://www.w3.org/1999/xhtml\">\n" +
                "<head>\n" +
                "    <meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" />\n" +
                "    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\" />\n" +
                "    <title>Deine Mitfahrgelegenheit bei PickmeUP</title>\n" +
                "\n" +
                "    <style type=\"text/css\">\n" +
                "        /* Take care of image borders and formatting, client hacks */\n" +
                "        img { max-width: 600px; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic;}\n" +
                ...
                "                    <tr>\n" +
                "                        <td class=\"free-text\">\n" +
                "                            Deine Mitfahrgelegenheit startet in einer Stunde! Alle Infos dazu findest du in deinem Dashboard:\n" +
                "                        </td>\n" +
                "                    </tr>\n" +
                "                    <tr>\n" +
                "                        <td class=\"button\">\n" +
        ...
        try {
            ...
            // Set Subject: header field
            message.setSubject("Deine Mitfahrgelegenheit bei PickmeUP");

            Multipart mp = new MimeMultipart();

            BodyPart pixPart = new MimeBodyPart();
            pixPart.setContent(journeyInfoHTML, "text/html");
    ...
    public static void sendChangedJourneyMailDriver(User user) {
        String to = user.getEmail();
        String from = "pickmeup.uni.passau@gmail.com";
        final String username = "pickmeup.uni.passau@gmail.com";
        final String password = "lukpkucfltvvpxkf";
        ...
        String changedJourneyHTML = "<html xmlns=\"http://www.w3.org/1999/xhtml\">\n" +
                ...
                "    <meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" />\n" +
                "    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\" />\n" +
                "    <title>Neuigkeiten bei deinen Fahrten!</title>\n" +
                "\n" +
                "    <style type=\"text/css\">\n" +
                "        /* Take care of image borders and formatting, client hacks */\n" +
                "        img { max-width: 600px; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic;}\n" +
                ...
                "                    <tr>\n" +
                "                        <td class=\"free-text\">\n" +
                "                            Soeben wurde eine deiner Fahrten abgeaendert oder storniert! Alle Infos dazu findest du in deinem Dashboard::\n" +
                "                        </td>\n" +
                "                    </tr>\n" +
                "                    <tr>\n" +
                "                        <td class=\"button\">\n" +
    ...
    public static void sendCancelBookedJourneyMailDriver(User user) {
        String to = user.getEmail();
        String from = "pickmeup.uni.passau@gmail.com";
        final String username = "pickmeup.uni.passau@gmail.com";
        final String password = "lukpkucfltvvpxkf";
        ...
        String changedJourneyHTML = "<html xmlns=\"http://www.w3.org/1999/xhtml\">\n" +
                ...
                "                    <tr>\n" +
                "                        <td class=\"free-text\">\n" +
                "                            Soeben hat ein Mitfahrer die Buchung zu einer deiner Fahrten storniert! Alle Infos dazu findest du in deinem Dashboard::\n" +
                "                        </td>\n" +
                "                    </tr>\n" +
                "                    <tr>\n" +
                "                        <td class=\"button\">\n" +
    ...
    public static void sendCancelBookedJourneyMailPassenger(User user) {
        String to = user.getEmail();
        String from = "pickmeup.uni.passau@gmail.com";
        final String username = "pickmeup.uni.passau@gmail.com";
        final String password = "lukpkucfltvvpxkf";
        ...
        String changedJourneyHTML = "<html xmlns=\"http://www.w3.org/1999/xhtml\">\n" +
                ...
                "                    <tr>\n" +
                "                        <td class=\"free-text\">\n" +
                "                            Deine Mitfahrt wurde erfolgreich storniert! Alle Infos dazu findest du in deinem Dashboard::\n" +
                "                        </td>\n" +
                "                    </tr>\n" +
                "                    <tr>\n" +
                "                        <td class=\"button\">\n" +
